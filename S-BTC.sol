...
/**
 * @title StackingDex Token
 * @dev Token that can create Stacking Dex orders.
 */
contract StackingDexToken is BurnableToken{
...
*/
contract SBTCToken is StackingDexToken {
    string public constant name = "S-BTC";
    string public constant symbol = "S-BTC";
